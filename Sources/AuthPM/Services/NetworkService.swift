...
//        then(.success(AvailableServices(socials: [])))
    ...
    func getLinkComponents(byAppId appId: Int, socialId: Int, device: String, then: @escaping (Result<URLComponentsForService, PMNetworkingError>) -> Void) {
    ...
    func linkRequest(byAppId: Int, then: @escaping URLComponents) {
